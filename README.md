...
- [auto_pta.ipynb](auto_pta.ipynb) is for the ORFs of auto-correlation of PTA redshifts. 
- [auto_astrometry.ipynb](auto_astrometry.ipynb) is for the ORFs of auto-correlation of astrometry deflections. 
- [cross.ipynb](cross.ipynb) is for the ORFs of cross-correlation between PTA redshifts and astrometry deflections. 
