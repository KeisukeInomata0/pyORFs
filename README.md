...
The Python functions neglect the imaginary numbers. So, when we plot the results, we additionally take into account the imaginary values, which change the expression of the y-axix of the figures. 
