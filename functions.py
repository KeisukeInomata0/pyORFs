...
def YY(l,ld,L,M,theta): # {Y_l(\hat n_a) x Y_ld(\hat n_b)}_{LM} with theta = arccos(\hat n_a \cdot \hat n_b)
    ...
    for m in range(-l,l+1):
        ...
        #NOTE: CG(j1,m1,j2,m2,J,M) = <j1,m1,j2,m2|J,M>, https://docs.sympy.org/latest/modules/physics/quantum/cg.html#sympy.physics.quantum.cg.cg_simp
    return yy
...
def GamI_be(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamV_be(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamE_be(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamB_be(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
## for BB with spin-2 GWs
def GamI_bb(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamV_bb(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamE_bb(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
...
def GamB_bb(L,M,theta,lmax,alpha,beta):
    gam = 0
    for l in range(2,lmax+1):
        for ld in range(2,lmax+1):
