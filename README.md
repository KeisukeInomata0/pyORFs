...
The exact analytic results for the redshift response due to the $I$-mode GW anisotropies, obtained in arXiv:1406.4664 (Gair, Romano, Taylor, Mingarelli, for tensor GWs) and arXiv:1506.08668 (Gair, Romano, Taylor, for vector GWs), are also implemented:
